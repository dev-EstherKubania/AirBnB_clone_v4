$(document).ready(function () {
  ...
  // Listening for changes on amenity checkboxes
  $('input[type="checkbox"][data-id]').change(function () {
    ...
    // Updating the h4 tag with the list of selected amenities
    updateAmenitiesList();
  });
  ...
  function updateAmenitiesList() {
    ...
    // Truncateing the list with three dots if it's over 24 characters
